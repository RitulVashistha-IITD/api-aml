...
av = AutoViz_Class()
a = av.AutoViz("Money_Laundering_Dataset.csv", chart_format = 'html')

import os
os.getcwd()

# If the dependent variable is known:
a = av.AutoViz("Money_Laundering_Dataset.csv", depVar = 'isFraud') # depVar - target variable in your dataset
